...
class KataQual_MainWindow_Ui(QWidget):
    def __init__(self):
        ...
        Form21.setStyleSheet("background-color: white;")
        ...
        self.btn_clearData = QtWidgets.QPushButton(self.Form21)
        self.btn_NewCategory = QtWidgets.QPushButton(self.Form21)
        self.btn_showData = QtWidgets.QPushButton(self.Form21)
        ...
        self.lineEdit_name_red_1 = QtWidgets.QLineEdit(self.Form21)
        self.lineEdit_region_red_1 = QtWidgets.QLineEdit(self.Form21)
        self.lineEdit_name_white_1 = QtWidgets.QLineEdit(self.Form21)
        self.lineEdit_region_white_1 = QtWidgets.QLineEdit(self.Form21)
        ...
        """
        self.frame_upper = QtWidgets.QFrame(self.Form21)
        ...
        self.btn_clearData.raise_()
        self.btn_NewCategory.raise_()
        self.btn_showData.raise_()
        ...
        self.retranslateUi(self.Form21)
        QtCore.QMetaObject.connectSlotsByName(self.Form21)
    ...
    def retranslateUi(self, Form21):
        ...
        self.btn_clearData.setText(_translate("Form21", "ОЧИСТИТЬ\nДАННЫЕ"))
        self.btn_NewCategory.setText(_translate("Form21", "НОВАЯ\nКАТЕГОРИЯ"))
        self.btn_showData.setText(_translate("Form21", "ПОКАЗАТЬ\nНА ЭКРАНЕ"))
