...
class KataSecondWindow_Ui(object):
    def setupUi_Kata2(self, Form12):
        ...
        self.label_name_red_2.setGeometry(QtCore.QRect(40, 120, 1010, 200))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(1)
        ...
        self.label_region_red_2.setGeometry(QtCore.QRect(40, 400, 1010, 100))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(1)
    ...
    def retranslateUi(self, Form12):
        ...
        self.label_region_red_2.setText(_translate("Form12", "НАИМЕНОВАНИЕ региона"))
...
class KataMainWindow_Ui(object):
    def setupUi(self, Form11):
        ...
        self.label_matchName1 = QtWidgets.QLabel(Form11)
        self.label_matchName2 = QtWidgets.QLabel(Form11)
        self.matchName1 = QtWidgets.QLineEdit(Form11)
        ...
        self.label_matchName1.setGeometry(QtCore.QRect(300, 0, 405, 15))
        ...
        self.label_matchName2.setGeometry(QtCore.QRect(290, 45, 480, 15))
        self.label_matchName2.setStyleSheet("color: grey; font-family: Gotham-Light; font-size: 9pt;")
        self.label_matchName2.setObjectName("label_matchName2")

        self.matchName1.setGeometry(QtCore.QRect(300, 15, 405, 30))
        ...
        self.label_name_red_1.setGeometry(QtCore.QRect(420, 40, 360, 100))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(1)
        ...
        self.label_region_red_1.setGeometry(QtCore.QRect(420, 90, 360, 100))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(1)
        ...
        self.heading_sum.setGeometry(QtCore.QRect(110, 0, 100, 20))
        self.heading_sum.setStyleSheet("font-family: Gotham-Light; font-size: 10pt;")
        ...
        self.label_sum.setStyleSheet("background-color: None; font-family: Gotham-Light; color: grey; font-size: 15pt;")
        self.label_sum.setObjectName("label_sum")

        self.referee_point = QtWidgets.QLabel(Form11)
        self.referee_point.setGeometry(QtCore.QRect(100, 170, 700, 70))
        self.referee_point.setAlignment(QtCore.Qt.AlignCenter)
        self.referee_point.setStyleSheet("font-family: Gotham-Bold; font-size: 30pt;")
    ...
    def retranslateUi(self, Form11):
        ...
        self.heading_sum.setText(_translate("Form11", "<b>Сумма балов</b>"))
        ...
        self.label_region_red_1.setText(_translate("Form11", "НАИМЕНОВАНИЕ региона"))
...
class KataMainWindow(QWidget, KataMainWindow_Ui):
    ...
    def calcResult(self):
        ...
        if len(m) < 3:
            ...
            self.label_sum.setStyleSheet("background-color: None; font-family: Gotham-Light; color: red; font-size: 15pt;")
        ...
        self.label_sum.setStyleSheet('background-color: None; font-family: Gotham-Light; font: 90pt; color: rgb(0, 178, 80);')
    ...
    def fiveReferee(self, TupleFiveRefereeScore):
        if TupleFiveRefereeScore == '':
    ...
    def setDataKata(self):
        ...
        if self.label_name_red_1.fontMetrics().boundingRect(self.label_name_red_1.text()).width() > 360:
            self.KataSecondWindow.label_name_red_2.setAlignment(QtCore.Qt.AlignLeft)
        else:
            self.KataSecondWindow.label_name_red_2.setAlignment(QtCore.Qt.AlignCenter)
        ...
        print('type', type(self.label_name_red_1.fontMetrics().boundingRect(self.label_name_red_1.text()).width()))
