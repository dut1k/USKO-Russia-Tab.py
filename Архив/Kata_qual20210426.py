...
class KataQual_MainWindow_Ui(object):
    def setupUi(self, Form21):
        ...
        self.lineEdit_name_red_2 = QtWidgets.QLineEdit(Form21)
        self.lineEdit_name_white_1 = QtWidgets.QLineEdit(Form21)
        self.lineEdit_name_white_2 = QtWidgets.QLineEdit(Form21)
        ...
        self.name_white_1.setStyleSheet("color: grey; font-family: Gotham-Medium; font-size: 10pt;")
        self.name_white_1.setAlignment(QtCore.Qt.AlignCenter)
        self.name_white_1.setObjectName("name_white_1")

        self.lineEdit_name_red_1.setGeometry(QtCore.QRect(50, 240, 340, 30))
        self.lineEdit_name_red_1.setStyleSheet("background-color: rgb(242, 242, 242);"
        ...
        self.lineEdit_name_red_2.setGeometry(QtCore.QRect(70, 290, 300, 30))
        self.lineEdit_name_red_2.setStyleSheet("background-color: rgb(242, 242, 242);"
                                               "font-family: Gotham-Light; font-size: 10pt;")
        self.lineEdit_name_red_2.setAlignment(QtCore.Qt.AlignCenter)
        self.lineEdit_name_red_2.setObjectName("lineEdit_name_red_2")

        self.lineEdit_name_white_1.setGeometry(QtCore.QRect(510, 240, 340, 30))
        self.lineEdit_name_white_1.setStyleSheet("background-color: rgb(242, 242, 242);"
                                             "font-family: Gotham-Light; font-size: 15pt;")
        self.lineEdit_name_white_1.setAlignment(QtCore.Qt.AlignCenter)
        self.lineEdit_name_white_1.setObjectName("lineEdit_name_white_2")

        self.lineEdit_name_white_2.setGeometry(QtCore.QRect(530, 290, 300, 30))
        self.lineEdit_name_white_2.setStyleSheet("background-color: rgb(242, 242, 242);"
                                               "font-family: Gotham-Light; font-size: 10pt;")
        self.lineEdit_name_white_2.setAlignment(QtCore.Qt.AlignCenter)
        self.lineEdit_name_white_2.setObjectName("lineEdit_name_white_1")
    ...
    def retranslateUi(self, Form21):
        ...
        self.lineEdit_name_red_2.setText(_translate("Form21", "АКА. Введите имя спортсмена"))
        self.lineEdit_name_white_1.setText(_translate("Form21", "СИРО. Введите имя спортсмена"))
        self.lineEdit_name_white_2.setText(_translate("Form21", "СИРО. Введите имя спортсмена"))
