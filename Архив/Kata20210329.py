...
class KataMainWindow_Ui(object):
    def setupUi(self, Form11):
        ...
        self.KumiteButton.setGeometry(QtCore.QRect(765, 35, 110, 20))
        ...
        self.Calc_Button.setStyleSheet("background-color: rgb(62, 106, 225); font-family: Gotham-Light;"
    ...
    def retranslateUi(self, Form11):
        _translate = QtCore.QCoreApplication.translate
        Form11.setWindowTitle(_translate("Form11", "Ката"))
...
class KataMainWindow(QWidget, KataMainWindow_Ui):
    ...
    def passingInformation(self):
        ...
        if len(m) < 3:
            self.label_sum.setStyleSheet("font-family: Gotham-Light; font: 15pt; color: red")
    ...
    def fiveReferee(self, sixReferee):
        if sixReferee == '':
            self.KataSecondWindow.input_referee1.setGeometry(QtCore.QRect(325, 740, 250, 250))
            self.KataSecondWindow.input_referee2.setGeometry(QtCore.QRect(580, 740, 250, 250))
            self.KataSecondWindow.input_referee3.setGeometry(QtCore.QRect(835, 740, 250, 250))
            self.KataSecondWindow.input_referee4.setGeometry(QtCore.QRect(1090, 740, 250, 250))
            self.KataSecondWindow.input_referee5.setGeometry(QtCore.QRect(1345, 740, 250, 250))
            self.KataSecondWindow.input_referee6.setGeometry(QtCore.QRect(2345, 740, 250, 250))
            self.KataSecondWindow.input_referee7.setGeometry(QtCore.QRect(2600, 740, 250, 250))
            self.KataSecondWindow.label_1.setGeometry(QtCore.QRect(325, 680, 250, 50))
            self.KataSecondWindow.label_2.setGeometry(QtCore.QRect(580, 680, 250, 50))
            self.KataSecondWindow.label_3.setGeometry(QtCore.QRect(835, 680, 250, 50))
            self.KataSecondWindow.label_4.setGeometry(QtCore.QRect(1090, 680, 250, 50))
            self.KataSecondWindow.label_5.setGeometry(QtCore.QRect(1345, 680, 250, 50))
            self.KataSecondWindow.label_6.setGeometry(QtCore.QRect(2345, 680, 250, 50))
            self.KataSecondWindow.label_7.setGeometry(QtCore.QRect(2600, 680, 250, 50))
        else:
            ...
            self.KataSecondWindow.input_referee6.setGeometry(QtCore.QRect(1345, 740, 250, 250))
            self.KataSecondWindow.input_referee7.setGeometry(QtCore.QRect(1600, 740, 250, 250))
