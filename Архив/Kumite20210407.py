...
class KumiteMainWindow_Ui(object):
    def setupUi(self, Form2):
        ...
        self.KataButton.setStyleSheet("background-color: rgb(242, 242, 242); "
                                      "font-family: Gotham-Light; font-size: 10pt;")
...
class KumiteMainWindow(QWidget, KumiteMainWindow_Ui):
    def __init__(self):
        ...
        # self.sound_gong1 = QSound("C:/Users/nikol/OneDrive/Рабочий стол/Disp/0_Main_Displ/gong1.wav")
        # self.sound_gong2 = QSound("C:/Users/nikol/OneDrive/Рабочий стол/Disp/0_Main_Displ/gong2.wav")
