...
# Кумите Ж личн ############################################
    ...
    def calcTabKataSpotrsmans2(self):
        ...
        print('n', n)
        print('self.sportsmans_ages_dict', len(set(self.sportsmans_ages_dict)), self.sportsmans_ages_dict)
        # print('разница = ', len(set(self.sportsmans_ages_dict) - set(self.female_label_dict) - set(self.individ_kumite_dict)), set(self.sportsmans_ages_dict) - set(self.female_label_dict) - set(self.individ_kumite_dict))
        print('разница = ', len(set(self.female_label_dict) - set(self.individ_kumite_dict)), set(self.female_label_dict) - set(self.individ_kumite_dict))
