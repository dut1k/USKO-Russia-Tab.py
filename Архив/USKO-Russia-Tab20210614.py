...
class MenuWindow(QWidget, Ui_Form0):
    def __init__(self):
        ...
        self.ui_kumite.pushButton_closeWin.clicked.connect(self.KumiteWindowsClose.show)
        ...
        self.ui_kataQual.pushButton_showData.clicked.connect(self.kata_matchName)
        self.ui_kataQual.pushButton_showData.clicked.connect(self.ui_kataQual.setMatchTitle)
        ...
        self.ui_kataFinal.pushButton_showData.clicked.connect(self.kata_matchName)
        self.ui_kataFinal.pushButton_showData.clicked.connect(self.ui_kataFinal.setMatchTitle)

        self.ui_kumite.pushButton_showData.clicked.connect(self.ui_kumite.setMatchTitle)
...
#         self.ui_kataQual.lineEdit_region_red_1.setText(name.split('a11')[1])
    ...
    def kata_matchName(self):
        sender = self.sender()
        if sender == self.ui_kataQual.pushButton_showData:
            ui_kata = self.ui_kataQual
        elif sender == self.ui_kataFinal.pushButton_showData:
