...
class KataQual_MainWindow_Ui(object):
    def setupUi(self, Form21):
        ...
        self.line1.setGeometry(QtCore.QRect(447, 80, 6, 200))
        font = QtGui.QFont()
        font.setKerning(True)
        ...
        self.frame_red1.setGeometry(QtCore.QRect(475, 80, 400, 200))
        ...
        self.label_region_red_1.setGeometry(QtCore.QRect(20, 120, 360, 100))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(1)
        ...
        self.frame_white1.setGeometry(QtCore.QRect(25, 80, 400, 200))
        ...
        self.label_region_white_1.setGeometry(QtCore.QRect(20, 120, 360, 100))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(1)
        ...
        self.pushButton_clearData.setGeometry(QtCore.QRect(475, 310, 200, 35))
        font = QtGui.QFont()
        font.setFamily("Gotham")
        font.setPointSize(15)
        ...
        self.pushButton_NewCategory.setGeometry(QtCore.QRect(775, 310, 100, 45))
        font = QtGui.QFont()
        ...
        self.pushButton_showData.setGeometry(QtCore.QRect(175, 310, 250, 35))
        font = QtGui.QFont()
        font.setFamily("Gotham")
        font.setPointSize(15)
        ...
        self.comboBox_age.setGeometry(QtCore.QRect(480, 380, 111, 22))
        self.comboBox_age.setObjectName("comboBox_age")

        self.frame_sex.setGeometry(QtCore.QRect(270, 380, 151, 25))
        ...
        self.sex_1.setGeometry(QtCore.QRect(330, 360, 47, 13))
        self.sex_1.setObjectName("sex_1")

        self.age_1.setGeometry(QtCore.QRect(520, 360, 47, 13))
        ...
        self.comboBox_name_white_1.setGeometry(QtCore.QRect(490, 450, 350, 25))
        self.comboBox_name_white_1.setObjectName("comboBox_name_white_1")

        self.name_red_1.setGeometry(QtCore.QRect(490, 430, 350, 16))
...
class KataQual_MainWindow(QWidget, KataQual_MainWindow_Ui):
    ...
    def NewCategory(self):
        print('окк1')
        self.KataQual_SecondWindow.label_name_white_2.setText("1Фамилия")
        self.KataQual_SecondWindow.label_region_white_2.setText("1НАИМЕНОВАНИЕ региона")
        self.KataQual_SecondWindow.label_region_red_2.setText("1НАИМЕНОВАНИЕ региона")
        self.KataQual_SecondWindow.label_name_red_2.setText("1Фамилия")
        print('о22')
