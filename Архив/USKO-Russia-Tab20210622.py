...
# from Kumite import Frame_Header
import resources
...
class MenuWindow(QWidget, Ui_Form0):
    def __init__(self):
        ...
        # self.header_kumite = Frame_Header()
        ...
        self.ui_kumite.btn_closeWin.clicked.connect(self.KumiteWindowsClose.show)
        ...
        self.ui_kumite.combo.activated[str].connect(self.choiseCompitition_Kumite)
