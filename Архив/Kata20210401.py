...
class KataMainWindow(QWidget, KataMainWindow_Ui):
    ...
    def fiveReferee(self, sixReferee):
        if sixReferee == '':
            ...
            # self.KataSecondWindow.input_referee2.setGeometry(QtCore.QRect(452, 740, 250, 250))
            # self.KataSecondWindow.input_referee3.setGeometry(QtCore.QRect(835, 740, 250, 250))
            # self.KataSecondWindow.input_referee4.setGeometry(QtCore.QRect(1217, 740, 250, 250))
            # self.KataSecondWindow.input_referee5.setGeometry(QtCore.QRect(1600, 740, 250, 250))
            # self.KataSecondWindow.input_referee6.setGeometry(QtCore.QRect(2345, 740, 250, 250))
            # self.KataSecondWindow.input_referee7.setGeometry(QtCore.QRect(2600, 740, 250, 250))
            # self.KataSecondWindow.label_1.setGeometry(QtCore.QRect(70, 680, 250, 50))
            # self.KataSecondWindow.label_2.setGeometry(QtCore.QRect(452, 680, 250, 50))
            # self.KataSecondWindow.label_3.setGeometry(QtCore.QRect(835, 680, 250, 50))
            # self.KataSecondWindow.label_4.setGeometry(QtCore.QRect(1217, 680, 250, 50))
            # self.KataSecondWindow.label_5.setGeometry(QtCore.QRect(1600, 680, 250, 50))
            # self.KataSecondWindow.label_6.setGeometry(QtCore.QRect(2345, 680, 250, 50))
            # self.KataSecondWindow.label_7.setGeometry(QtCore.QRect(2600, 680, 250, 50))
        else:
            self.KataSecondWindow.input_referee1.setGeometry(QtCore.QRect(70, 740, 250, 250))
