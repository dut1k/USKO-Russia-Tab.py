...
class KataMainWindow(QWidget, KataMainWindow_Ui):
    ...
    def calcResult(self):
        ...
        if len(m) < 3:
            ...
            self.label_sum.setStyleSheet("background-color: None; font-family: Gotham-Light; color: red; font-size: 20px;")
        ...
        self.label_sum.setStyleSheet('background-color: None; font-family: Gotham-Light; font-size: 120px; color: rgb(0, 178, 80);')
