...
from Kata_final import KataSecondWindow
...
class MenuWindow(QWidget, Ui_Form0):
    ...
    def calc_monitor_coord(self):
        print(1)
        # self.display_coord_x1 = 'undefined'
        self.display_coord_x1_secW = 'undefined'
        if self.list_monitor[7] == 'is_primary=True':
            self.display_coord_x1 = int(self.list_monitor[0].replace('Monitor(x=', ''))+1
            self.display_width = int(self.list_monitor[2].replace('width=', ''))
            self.display_coord_y1 = int(self.list_monitor[1].replace('y=', ''))+1
            self.display_height = int(self.list_monitor[3].replace('height=', ''))
            print(self.display_coord_x1, self.display_width, self.display_coord_y1, self.display_height)
