...
class Ui_Form0(object):
    ...
    def retranslateUi(self, Form0):
        ...
        Form0.setWindowIcon(QtGui.QIcon('icon.ico'))
...
class dialogWindow_Ui(object):
    def setupUi_dialog(self, Dialog):
        ...
        # self.buttonBox.setStyleSheet(self.Ui_Form0.btn_style_1)
        ...
        self.btn_OK.setStyleSheet(self.Ui_Form0.btn_style_1)
        font = QtGui.QFont()
        font.setFamily("Gotham-Light")
        font.setPixelSize(30)
        ...
        self.btn_CANCEL.setStyleSheet(self.Ui_Form0.btn_style_1)
        font = QtGui.QFont()
        font.setFamily("Gotham-Light")
        font.setPixelSize(30)
