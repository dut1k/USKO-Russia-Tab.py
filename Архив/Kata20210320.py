...
class KataSecondWindow_Ui(object):
    def setupUi2(self, Form):
        ...
        self.label_sum2 = QtWidgets.QLabel(Form)
        self.input_referee1 = QtWidgets.QLabel(Form)
        self.input_referee2 = QtWidgets.QLabel(Form)
        self.input_referee3 = QtWidgets.QLabel(Form)
        self.input_referee4 = QtWidgets.QLabel(Form)
        self.input_referee5 = QtWidgets.QLabel(Form)
        self.input_referee6 = QtWidgets.QLabel(Form)
        self.input_referee7 = QtWidgets.QLabel(Form)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_sum2.setText(_translate("Form", ""))
        ...
        self.input_referee6.setText(_translate("Form", ""))
        self.input_referee4.setText(_translate("Form", ""))
        self.input_referee2.setText(_translate("Form", ""))
        self.input_referee7.setText(_translate("Form", ""))
        self.input_referee1.setText(_translate("Form", ""))
        self.input_referee3.setText(_translate("Form", ""))
        self.input_referee5.setText(_translate("Form", ""))
...
class KataMainWindow_Ui(object):
    def setupUi(self, Form2):
        ...
        self.Clear_Button = QtWidgets.QPushButton(Form2)
        ...
        self.heading_sum = QtWidgets.QLabel(Form2)
        ...
        self.label_sum = QtWidgets.QLabel(Form2)
        ...
        self.referee_point = QtWidgets.QLabel(Form2)
        ...
        self.label_help = QtWidgets.QLabel(Form2)
        ...
        self.lineEdit_referee1 = QtWidgets.QLineEdit(Form2)
        ...
        self.lineEdit_referee2 = QtWidgets.QLineEdit(Form2)
        ...
        self.lineEdit_referee3 = QtWidgets.QLineEdit(Form2)
        ...
        self.lineEdit_referee4 = QtWidgets.QLineEdit(Form2)
        ...
        self.lineEdit_referee5 = QtWidgets.QLineEdit(Form2)
        ...
        self.lineEdit_referee6 = QtWidgets.QLineEdit(Form2)
        ...
        self.lineEdit_referee7 = QtWidgets.QLineEdit(Form2)
        ...
        self.label_1 = QtWidgets.QLabel(Form2)
    ...
    def retranslateUi(self, Form2):
        ...
        self.KumiteButton.setText(_translate("Form2", "Кумите"))
        self.Clear_Button.setText(_translate("Form2", "Очистить"))
        self.Calc_Button.setText(_translate("Form2", "Рассчитать"))
        self.heading_sum.setText(_translate("Form2", "Сумма балов"))
        self.label_sum.setText(_translate("Form2", "Нажми кнопку «Рассчитать»"))
        self.referee_point.setText(_translate("Form2", "Оценки судей"))
        self.label_help.setText(_translate("Form2", "Переключайся между судьями кнопкой Tab"))
        self.label_1.setText(_translate("Form2", "1 судья"))
        self.label_2.setText(_translate("Form2", "2 судья"))
        self.label_3.setText(_translate("Form2", "3 судья"))
        self.label_4.setText(_translate("Form2", "4 судья"))
        self.label_5.setText(_translate("Form2", "5 судья"))
        self.label_6.setText(_translate("Form2", "6 судья"))
        self.label_7.setText(_translate("Form2", "7 судья"))
