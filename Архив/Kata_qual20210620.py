...
class KataQual_MainWindow_Ui(object):
    def setupUi(self, Form21):
        ...
        self.btn_clearData = QtWidgets.QPushButton(Form21)
        self.btn_NewCategory = QtWidgets.QPushButton(Form21)
        self.btn_showData = QtWidgets.QPushButton(Form21)
    ...
    def retranslateUi(self, Form21):
        ...
        self.btn_closeWin.setText(_translate("Form21", "×"))
        self.btn_showMinimized.setText(_translate("Form21", "_"))
