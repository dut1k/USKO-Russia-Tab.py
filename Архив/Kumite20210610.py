...
class KumiteMainWindow_Ui(object):
    def setupUi(self, Form2):
        ...
        self.MenuButton.setStyleSheet(self.btn_style_1)
        font = QtGui.QFont()
        font.setFamily("Gotham-Light")
        font.setPixelSize(13)
        ...
        self.KataQualButton.setStyleSheet(self.btn_style_1)
        font = QtGui.QFont()
        font.setFamily("Gotham-Light")
        font.setPixelSize(13)
        self.KataQualButton.setFont(font)
        self.KataQualButton.setObjectName("KataQualButton")

        self.KataFinalButton.setGeometry(QtCore.QRect(20, 55, 110, 20))
        self.KataFinalButton.setStyleSheet(self.btn_style_1)
        font = QtGui.QFont()
        font.setFamily("Gotham-Light")
        font.setPixelSize(13)
        self.KataFinalButton.setFont(font)
...
class KumiteMainWindow(QWidget, KumiteMainWindow_Ui):
    ...
    def setStyleButton(self, rad_M0, rad_M1, rad_M2, rad_M3, rad_S1, rad_S2, rad_S3,
        ...
        # rad_M0.setStyleSheet('background-color: none; font-family: Gotham-Light; font: 20px')
        # rad_M1.setStyleSheet('background-color: none; font-family: Gotham-Light; font: 20px;')
        # rad_M2.setStyleSheet('background-color: none; font-family: Gotham-Light; font: 20px;')
