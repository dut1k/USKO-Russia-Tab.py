...
class Ui_Form0(object):
    ...
    def retranslateUi(self, Form0):
        ...
        self.pushButton_Kata_qual.setText(_translate("Form", "Ката по флажкам"))
        self.pushButton_Kata_final.setText(_translate("Form", "Ката финал"))
...
class KataQualToKumite(QWidget, dialogWindow_Ui):
    def __init__(self):
        ...
        self.label2.setText("Окно \"Ката по флажкам\" закроется")
        self.setWindowTitle(" ")
...
class KataFinalToKataQual(QWidget, dialogWindow_Ui):
    def __init__(self):
        super().__init__()
        self.setupUi_dialog(self)
        self.label.setText("Открыть окно \"Ката по флажкам\"?")
        self.label2.setText("Окно \"Ката финал\" закроется")
        self.setWindowTitle(" ")
        self.buttonBox.accepted.connect(self.closeWin)
...
class KataQualToKataFinal(QWidget, dialogWindow_Ui):
    def __init__(self):
        super().__init__()
        self.setupUi_dialog(self)
        self.label.setText("Открыть окно \"Ката финал\"?")
        self.label2.setText("Окно \"Ката по флажкам\" закроется")
        self.setWindowTitle(" ")
        self.buttonBox.accepted.connect(self.closeWin)
