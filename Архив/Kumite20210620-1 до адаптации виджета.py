...
class KumiteMainWindow_Ui(object):
    def setupUi(self, Form2):
        ...
        self.frame_combo = QtWidgets.QFrame(Form2)
        ...
        self.btn_clearData = QtWidgets.QPushButton(self.frame_matchName)
        self.btn_showData = QtWidgets.QPushButton(self.frame_matchName)
        ...
        self.btn_reset = QtWidgets.QPushButton(self.control_panel)
        self.btn_pause = QtWidgets.QPushButton(self.control_panel)
        self.btn_start = QtWidgets.QPushButton(self.control_panel)
    ...
    def retranslateUi(self, Form2):
        ...
        self.btn_closeWin.setText(_translate("Form2", "×"))
        self.btn_showMinimized.setText(_translate("Form2", "_"))
        ...
        self.btn_reset.setText(_translate("Form2", "НОВЫЙ БОЙ"))
        self.btn_pause.setText(_translate("Form2", "ОБНУЛИТЬ ТАЙМЕР"))
        self.btn_start.setText(_translate("Form2", "► START"))

        self.winnerRed.setText(_translate("Form2", "Победил АКА"))
        self.winnerWhite.setText(_translate("Form2", "Победил СИРО"))

        self.btn_clearData.setText(_translate("Form2", "ОЧИСТИТЬ\nДАННЫЕ"))
        self.btn_showData.setText(_translate("Form2", "ПОКАЗАТЬ\nНА ЭКРАНЕ"))
