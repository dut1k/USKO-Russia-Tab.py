...
class Frame_Header(QWidget):
    def __init__(self, parent):
        ...
        self.label_windowsTitle = QLabel("Ката финал. Судейское окно", self.frame_title)
...
class KataMainWindow_Ui(QWidget):
    def __init__(self):
        ...
        self.lineEdit_name_red_1 = QtWidgets.QLineEdit("Введите имя спортсмена", self.Form11)
        self.lineEdit_region_red_1 = QtWidgets.QLineEdit("Введите регион", self.Form11)
        ...
        self.btn_clearData.setGeometry(QtCore.QRect(710, 400, 170, 30))
        ...
        self.btn_showData.setGeometry(QtCore.QRect(650, 350, 230, 40))
        ...
        self.heading_sum = QtWidgets.QLabel("<b>Сумма баллов</b>", self.Form11)
        ...
        self.label_sum = QtWidgets.QLabel("Нажми кнопку «Рассчитать»", self.Form11)
        ...
        self.lineEdit_referee1 = QtWidgets.QLineEdit(self.Form11)
        ...
        self.lineEdit_referee2 = QtWidgets.QLineEdit(self.Form11)
        ...
        self.lineEdit_referee3 = QtWidgets.QLineEdit(self.Form11)
        ...
        self.lineEdit_referee4 = QtWidgets.QLineEdit(self.Form11)
        ...
        self.lineEdit_referee5 = QtWidgets.QLineEdit(self.Form11)
        ...
        self.lineEdit_referee6 = QtWidgets.QLineEdit(self.Form11)
        ...
        self.lineEdit_referee7 = QtWidgets.QLineEdit(self.Form11)
        ...
        self.label_1 = QtWidgets.QLabel("1 судья", self.Form11)
        ...
        self.label_2 = QtWidgets.QLabel("2 судья", self.Form11)
        ...
        self.label_3 = QtWidgets.QLabel("3 судья", self.Form11)
        ...
        self.label_4 = QtWidgets.QLabel("4 судья", self.Form11)
        ...
        self.label_5 = QtWidgets.QLabel("5 судья", self.Form11)
        ...
        self.label_6 = QtWidgets.QLabel("6 судья", self.Form11)
        ...
        self.label_7 = QtWidgets.QLabel("7 судья", self.Form11)
