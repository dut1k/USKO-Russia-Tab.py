...
class KataQual_MainWindow_Ui(object):
    def setupUi(self, Form21):
        ...
        self.label_name_red_1.setGeometry(QtCore.QRect(100, 50, 200, 40))
        ...
        self.label_region_red_1.setGeometry(QtCore.QRect(100, 100, 200, 40))
        ...
        self.label_name_white_1.setGeometry(QtCore.QRect(100, 50, 200, 40))
        ...
        self.label_region_white_1.setGeometry(QtCore.QRect(100, 100, 200, 40))
        ...
        self.winnerRed.setStyleSheet("font-family: Gotham-Light; font-size: 15pt;")
        self.winnerRed.setObjectName("winnerRed")

        self.winnerWhite.setGeometry(QtCore.QRect(0, 0, 200, 25))
        self.winnerWhite.setStyleSheet("font-family: Gotham-Light; font-size: 15pt;")
...
class KataQual_MainWindow(QWidget, KataQual_MainWindow_Ui):
    ...
    def setDataKata(self):
        ...
        secondWindowNameRed = self.KataQual_SecondWindow.label_name_red_2.fontMetrics().boundingRect(self.KataQual_SecondWindow.label_name_red_2.text()).width()
        firstWindowRegionRed = self.label_region_red_1.fontMetrics().boundingRect(self.label_region_red_1.text()).width()
        secondWindowRegionRed = self.KataQual_SecondWindow.label_region_red_2.fontMetrics().boundingRect(self.KataQual_SecondWindow.label_region_red_2.text()).width()

        if firstWindowNameRed > 200:
            self.label_name_red_1.setAlignment(QtCore.Qt.AlignLeft | QtCore.Qt.AlignVCenter)
        else:
            self.label_name_red_1.setAlignment(QtCore.Qt.AlignCenter)
        if secondWindowNameRed > 800:
            self.KataQual_SecondWindow.label_name_red_2.setAlignment(QtCore.Qt.AlignLeft | QtCore.Qt.AlignVCenter)
        else:
            self.KataQual_SecondWindow.label_name_red_2.setAlignment(QtCore.Qt.AlignCenter)

        if firstWindowRegionRed > 200:
            self.label_region_red_1.setAlignment(QtCore.Qt.AlignLeft | QtCore.Qt.AlignVCenter)
        else:
            self.label_region_red_1.setAlignment(QtCore.Qt.AlignCenter)
        if secondWindowRegionRed > 800:
            self.KataQual_SecondWindow.label_region_red_2.setAlignment(QtCore.Qt.AlignLeft | QtCore.Qt.AlignVCenter)
        else:
            self.KataQual_SecondWindow.label_region_red_2.setAlignment(QtCore.Qt.AlignCenter)

        firstWindowNameWhite = self.label_name_white_1.fontMetrics().boundingRect(self.label_name_white_1.text()).width()
        secondWindowNameWhite = self.KataQual_SecondWindow.label_name_white_2.fontMetrics().boundingRect(
            self.KataQual_SecondWindow.label_name_white_2.text()).width()
        firstWindowRegionWhite = self.label_region_white_1.fontMetrics().boundingRect(
            self.label_region_white_1.text()).width()
        secondWindowRegionWhite = self.KataQual_SecondWindow.label_region_white_2.fontMetrics().boundingRect(
            self.KataQual_SecondWindow.label_region_white_2.text()).width()

        if firstWindowNameWhite > 200:
            self.label_name_white_1.setAlignment(QtCore.Qt.AlignLeft | QtCore.Qt.AlignVCenter)
        else:
            self.label_name_white_1.setAlignment(QtCore.Qt.AlignCenter)
        if secondWindowNameWhite > 800:
            self.KataQual_SecondWindow.label_name_white_2.setAlignment(QtCore.Qt.AlignLeft | QtCore.Qt.AlignVCenter)
        else:
            self.KataQual_SecondWindow.label_name_white_2.setAlignment(QtCore.Qt.AlignCenter)

        if firstWindowRegionWhite > 200:
            self.label_region_white_1.setAlignment(QtCore.Qt.AlignLeft | QtCore.Qt.AlignVCenter)
        else:
            self.label_region_white_1.setAlignment(QtCore.Qt.AlignCenter)
        if secondWindowRegionWhite > 800:
            self.KataQual_SecondWindow.label_region_white_2.setAlignment(QtCore.Qt.AlignLeft | QtCore.Qt.AlignVCenter)
        else:
            self.KataQual_SecondWindow.label_region_white_2.setAlignment(QtCore.Qt.AlignCenter)

        print('длина имя (red1) в пикселях', self.label_name_red_1.fontMetrics().boundingRect(self.label_name_red_1.text()).width())
        print('длина имя (red2) в пикселях',
              self.KataQual_SecondWindow.label_name_red_2.fontMetrics().boundingRect(self.KataQual_SecondWindow.label_name_red_2.text()).width())

        print('длина региона (red1) в пикселях', self.label_region_red_1.fontMetrics().boundingRect(self.label_region_red_1.text()).width())
        print('длина региона (red2) в пикселях',
              self.KataQual_SecondWindow.label_region_red_2.fontMetrics().boundingRect(self.KataQual_SecondWindow.label_region_red_2.text()).width())

        print('длина имя (white1) в пикселях', self.label_name_white_1.fontMetrics().boundingRect(self.label_name_white_1.text()).width())

    def setWinnerRed(self):
        print('1111', 'setWinnerRed')
        self.KataQual_SecondWindow.label_name_red_2.show()
        self.KataQual_SecondWindow.label_region_red_2.show()
        self.KataQual_SecondWindow.label_name_white_2.hide()
        self.KataQual_SecondWindow.label_region_white_2.hide()
    ...
    def setWinnerWhite(self):
        ...
        self.KataQual_SecondWindow.label_name_white_2.show()
        self.KataQual_SecondWindow.label_region_white_2.show()
        self.KataQual_SecondWindow.label_name_red_2.hide()
        self.KataQual_SecondWindow.label_region_red_2.hide()
