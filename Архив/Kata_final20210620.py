...
class KataMainWindow_Ui(object):
    def setupUi(self, Form11):
        ...
        self.btn_clearData = QtWidgets.QPushButton(Form11)
        self.btn_NewCategory = QtWidgets.QPushButton(Form11)
        self.btn_showData = QtWidgets.QPushButton(Form11)
    ...
    def retranslateUi(self, Form11):
        ...
        self.btn_clearData.setText(_translate("Form21", "Очистить данные"))
        self.btn_NewCategory.setText(_translate("Form21", "Новая \n категория"))
        self.btn_showData.setText(_translate("Form21", "Показать фамилию \n на экране"))
