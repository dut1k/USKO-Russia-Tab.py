...
class KataQual_SecondWindow_Ui(object):
    def setupUi2(self, Form22):
        ...
        self.matchName2.setStyleSheet("font-family: Gotham-Medium; font-size: 75px; color: red;")
        ...
        self.label_region_red_2.setStyleSheet(
            "background-color: none; font-family: Gotham-Medium; font-size: 150px; ")
...
class KataQual_MainWindow(QWidget, KataQual_MainWindow_Ui):
    ...
    def setDataKata(self):
        ...
        if firstWindowNameWhite > 200:
            ...
            self.label_name_white_1.setAlignment(QtCore.Qt.AlignCenter)
        if secondWindowNameWhite > 1750:
            self.KataQual_SecondWindow.label_name_white_2.setAlignment(QtCore.Qt.AlignLeft | QtCore.Qt.AlignVCenter)
            font = QtGui.QFont()
            font.setFamily("Complex")
            font.setPixelSize(25)
            self.KataQual_SecondWindow.label_name_white_2.setFont(font)
            self.KataQual_SecondWindow.label_name_white_2.setStyleSheet("font-family: Complex; font-size: 25px;")
            print('qqqq',secondWindowNameWhite, int(250 * (1750 / secondWindowNameWhite)), self.KataQual_SecondWindow.label_name_white_2.text())
            self.KataQual_SecondWindow.label_name_white_2.setText('self.lineEdit_name_white_1.text()')
        else:
        ...
        if firstWindowRegionWhite > 200:
            ...
            self.label_region_white_1.setAlignment(QtCore.Qt.AlignCenter)
        if secondWindowRegionWhite > 1750:
