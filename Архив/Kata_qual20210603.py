...
class KataQual_MainWindow(QWidget, KataQual_MainWindow_Ui):
    ...
    def setDataKata(self):
        ...
        if firstWindowNameWhite or firstWindowNameRed > 237:
            ...
            # n = "font-family: Gotham-Medium; font-size: " + str(int(250 * (1750 / secondWindowNameWhite))) + "px;"

            n = "font-family: Gotham-Medium; font-size: " + str(int(7.5 * 40 * (198 / max_value))) + "px;"
            print('n =', n)
            ...
            self.KataQual_SecondWindow.label_name_white_2.setText('qqqqqqqqq\nqqqqqqqq')
        else:
            self.KataQual_SecondWindow.label_name_white_2.setStyleSheet(
                "background-color: none; font-family: Gotham-Medium; font-size: 250px; ")
            # self.KataQual_SecondWindow.label_name_white_2.setAlignment(QtCore.Qt.AlignCenter)
