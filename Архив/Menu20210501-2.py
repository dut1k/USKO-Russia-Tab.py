...
# Кумите Ж личн ############################################
    ...
    def calcTabKataSpotrsmans(self):
        ...
        if sender.text() == "М":  # pushButton pressed:
            self.sexProperties(self.female_label_dict)
        if sender.text() == "Ж":  # pushButton pressed:
            self.sexProperties(self.male_label_dict)

    def sexProperties(self, someDict):
    ...
    def calcTabKataSpotrsmansRed(self):
        self.calcTab(self.ui_kataQual.name_red_1, self.ui_kataQual.comboBox_name_red_1, self.setLabelRed)

    def calcTabKataSpotrsmansWhite(self):
        self.calcTab(self.ui_kataQual.name_white_1, self.ui_kataQual.comboBox_name_white_1, self.setLabelWhite)

    def calcTab(self, name, comboBox_name, setLabelColor):
        comboBox_name.clear()
        ...
        # comboBox_name.activated[str].connect(setLabelColor)
