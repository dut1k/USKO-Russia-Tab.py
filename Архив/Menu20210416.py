...
#                print(list_kat_name)
                ...
                for k_n in list_kat_name:
                    ...
                    print('111 = ', type(df_list2), df_list2)
#                    df_list2 = list(str(df_list2).replace("', '" , ' ', 1).replace("', '" , ' - ')
#                     print('222 = ', type(df_list2), df_list2)

                    df_list2 = [' '.join(map(str, x)) for x in df_list2]
                    df_list2 = [' '.join(map(str, x)) for x in df_list2]
                    print('333 = ', type(df_list2), df_list2)
                    # print('df_list2 = ', type(df_list2), df_list2)
...
#                    list4.append(df_list22.replace('[', '').replace(']', '').replace('\'', '').replace(',', ' -'))
                ...
                k = df_list3[0]
                print('type(list44[0]) = ', type(list44[0]), list44[0])
                print('type(df_list3[0]) = ', type(df_list3[0]), df_list3[0])
                print(len(df_list3), len(df_list3[0]), 'k[0] = ', k[0])
                ...
                self.combo.addItems(sorted(df_list3[0]))
            except:
