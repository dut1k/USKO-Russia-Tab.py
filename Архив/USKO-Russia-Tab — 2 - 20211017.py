...
class MenuWindow(QWidget, Ui_Form0):
    ...
    def data_processing(self):
        ...
        if self.file:
            ...
            try:
                ...
                value_list = set(self.sheet['a14'].values.tolist())
                for i in check_list_dementieva:
                    if i in value_list:
                        self.countRowTab = self.sheet.loc[self.sheet['a14'] == i].index[0]
                        self.file_dementieva()
                for i in check_list_yutkin:
                    if i in value_list:
                        self.countRowTab = self.sheet.loc[self.sheet['a14'] == i].index[0]
                        self.file_yutkin()

                print(self.countRowTab)
    ...
    def file_dementieva(self):
        ...
        if 'юн-ки' not in type_set:                                     # Ж
            self.female_label_dict1 = {}
        print('self.male_label_dict= ', self.male_label_dict)
        print('self.female_label_dict= ', self.female_label_dict)
        ...
        print('self.individ_kata_male_dict=', self.individ_kata_male_dict)
        ...
        print('self.individ_kata_female_dict=', self.individ_kata_female_dict)
