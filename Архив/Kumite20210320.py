...
class KumiteSWindow_Ui(object):
    def setupUi2(self, Form):
        ...
        self.label_score22 = QtWidgets.QLabel(self)
        ...
        self.label_kum_jw1 = QtWidgets.QLabel(self)
...
class KumiteMainWindow(QWidget, KumiteMainWindow_Ui):
    def __init__(self):
        ...
        self.plus5sec.clicked.connect(self.upTime)
        self.minus5sec.clicked.connect(self.downTime)
        ...
        self.score_red_3.toggled.connect(self.onClickedR)
        self.score_red_4.toggled.connect(self.onClickedR)
        self.score_red_5.toggled.connect(self.onClickedR)
        self.score_red_6.toggled.connect(self.onClickedR)
        self.score_white_0.toggled.connect(self.onClickedW)
        self.score_white_1.toggled.connect(self.onClickedW)
        self.score_white_2.toggled.connect(self.onClickedW)
        self.score_white_3.toggled.connect(self.onClickedW)
        self.score_white_4.toggled.connect(self.onClickedW)
        self.score_white_5.toggled.connect(self.onClickedW)
        self.score_white_6.toggled.connect(self.onClickedW)

        self.h_red1.toggled.connect(self.penaltyButton_hmr1)
        self.h_red2.clicked.connect(self.penaltyButton_hmr2)
        self.h_red3.clicked.connect(self.penaltyButton_hmr3)
        self.h_red4.clicked.connect(self.penaltyButton_hmr4)

        self.j_red1.toggled.connect(self.penaltyButton_jr1)
        self.j_red2.clicked.connect(self.penaltyButton_jr2)
        self.j_red3.clicked.connect(self.penaltyButton_jr3)
        self.j_red4.clicked.connect(self.penaltyButton_jr4)

        self.h_white1.toggled.connect(self.penaltyButton_hmw1)
        self.h_white2.clicked.connect(self.penaltyButton_hmw2)
        self.h_white3.clicked.connect(self.penaltyButton_hmw3)
        self.h_white4.clicked.connect(self.penaltyButton_hmw4)

        self.j_white1.toggled.connect(self.penaltyButton_jw1)
        self.j_white2.clicked.connect(self.penaltyButton_jw2)
        self.j_white3.clicked.connect(self.penaltyButton_jw3)
