...
##############################################
        ...
        self.label_winner_red_2.raise_()
        self.label_winner_white_2.raise_()
    ...
    def retranslateUi(self, Form):
        ...
        self.label_winner_red_2.setText(_translate("Form", "ПОБЕДА"))
        self.label_winner_white_2.setText(_translate("Form", "ПОБЕДА"))
...
class KumiteMainWindow_Ui(object):
    def setupUi(self, Form2):
        ...
        self.plus2sec = QtWidgets.QPushButton(Form2)
        self.minus2sec = QtWidgets.QPushButton(Form2)
        ...
        self.plus2sec.setGeometry(QtCore.QRect(470, 65, 40, 17))
        self.plus2sec.setStyleSheet("background-color: 204, 204, 204")
        self.plus2sec.setObjectName("plus2sec")

        self.minus2sec.setGeometry(QtCore.QRect(390, 65, 40, 17))
        self.minus2sec.setStyleSheet("background-color: 204, 204, 204")
...
class KumiteMainWindow(QWidget, KumiteMainWindow_Ui):
    ...
    def clearKumiteData(self):
        ...
        self.KumiteSecondWindow.label_winner_red_2.hide()
        self.KumiteSecondWindow.label_winner_white_2.hide()
    ...
    def setWinnerRed(self):
        self.KumiteSecondWindow.label_winner_white_2.hide()
        self.KumiteSecondWindow.label_winner_red_2.show()
        self.KumiteSecondWindow.frame_red2.show()
        self.KumiteSecondWindow.frame_white2.hide()
        self.KumiteSecondWindow.label_winner_red_2.setText('ПОБЕДА')

    def setWinnerWhite(self):
        self.KumiteSecondWindow.label_winner_red_2.hide()
        self.KumiteSecondWindow.label_winner_white_2.show()
        self.KumiteSecondWindow.frame_white2.show()
        self.KumiteSecondWindow.frame_red2.hide()
        self.KumiteSecondWindow.label_winner_white_2.setText('ПОБЕДА')
