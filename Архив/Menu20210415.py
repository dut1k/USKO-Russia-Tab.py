...
#                print(list_kat_name)
                ...
                for k_n in list_kat_name:
                    ...
                    df_list2 = list(zip(df2.a12 + ' ' + df2.a13, df2.a11))
                    df_list22 = list(map(list, zip(df2.a12 + ' ' + df2.a13, df2.a11)))
                    # print(len(df_list22),df_list22)
                    # print(type(df_list22[0]))

                    for x in df_list22:
                        # x = str(x).replace("', '" , ' - ')
                        list4.append(str(x).replace("', '" , ' - ').replace('[\'', '').replace('\']', ''))
                        # print(x)
                    list44.append(list4)
                    print('type(list44[0]) = ', type(list44[0]), list44[0])

#                    print(k_n, 'df_list22 = ', df_list22)
#                    list4.append(df_list22.replace('[', '').replace(']', '').replace('\'', '').replace(',', ' -'))


                    df_names.append(k_n)
                    df_list.append(df_dict)
                    df_list3.append(df_list2)
                    df_list33.append(df_list22)

                xxx = df_list33[0]
                zzz = list44[0]
                # print('xxx[0]) = ', type(xxx[0]), xxx[0])
                # print('zzz[0]) = ', type(zzz[0]), zzz[0])
                # print('df_list33 = ', df_list33)
                # print('type(df_list33[0]) = ', type(df_list33[0]))
                # print('type(list44[0]) = ', type(list44[0]))
                # print(list4)
...
#                     for i in df_list22:
#                         k = str(i)
#                         list4.append(k.replace('[', '').replace(']', '').replace('\'', '').replace(',', ' -'))
#                         # list4.append(k.replace('[', '').replace(']', '').replace('\'', '').replace(',', ' -'))
#                     list44.append(list4)
#                 print('len(list44) = ', len(list44))
# #                print(list44)
# #                print('len(list44[0]) = ', len(list44[0]), list44[0], '\n\n')
#                 kk = list44[0]
#                 print('len(kk) = ', len(kk))
#                 print('len(kk[0]) = ', len(kk[0]), 'kk[0] = ', kk[0])
#                 print(list44[0])
#                 print('list4 = ', list4)
#
# ############################### обработка списка под формат ФИО - Регион###############################
#                 # df_list33 = [['Бобков Иван Евгеньевич', 'КОСТРОМСКАЯ область'],
#                 #              ['Викулин Данил Алексеевич', 'МОСКОВСКАЯ область'],
#                 #              ['Ешурин Владимир Владимирович', 'МОСКВА'],
#                 #              ['Зубков Вадим Александрович', 'ВЛАДИМИРСКАЯ область'],
#                 #              ['Кучканов Иван Иванович', 'РЯЗАНСКАЯ область'], ['Манжосов Пётр Алексеевич', 'МОСКВА'],
#                 #              ['Матвеев Евгений Игоревич', 'ВЛАДИМИРСКАЯ область'],
#                 #              ['Питкевич Архип Сергеевич', 'РЯЗАНСКАЯ область'],
#                 #              ['Пичерига Даниил Анатольевич', 'ТУЛЬСКАЯ область'],
#                 #              ['Симаков Денис Юрьевич', 'РЯЗАНСКАЯ область']]
#                 # list = []
#                 # for i in df_list33:
#                 #     k = str(i)
#                 #     list.append(k.replace('[', '').replace(']', '').replace('\'', '').replace(',', ' -'))
#                 # print(list)
# #############################################################################################
#                 # print(type(df_dict), df_dict)
#                 # print('df_list', df_list)
#                 # print(len(df_list))
#                 # print(type(df_names), 'df_names',df_names)
#                 # print(type(df_list), df_list)
#                 # print(type(df_list3), len(df_list3), 'df_list3', df_list3)
#                 # print('df_list2 = ', list(df_list2[0]), '\n', type(df_list2[0]))
#                 # print(type(df_list[0]))
#                 print(type(zip(df2.a12 + ' ' + df2.a13, df2.a11)))
#                 print(type(df_list3[0]),'df_list3[0] = ',sorted(df_list3[0]))
#                 k2 = df_list3[0]
#                 print(type(k2[0]), 'k2[0] = ', sorted(k2[0]))
#                 print(type(df_list33[0]), 'df_list33[0] = ', sorted(df_list33[0]))
#                 k22 = df_list33[0]
#                 print(type(k22[0]), 'k2[0] = ', sorted(k22[0]))
#                 print(type(df_list[0]), 'df_list[0] = ', sorted(df_list[0]))
