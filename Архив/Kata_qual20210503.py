...
class KataQual_SecondWindow_Ui(object):
    def setupUi2(self, Form22):
        ...
        self.matchName2.setStyleSheet("font-family: Gotham-Medium; font-size: 45pt;")
...
class KataQual_MainWindow_Ui(object):
    ...
    def retranslateUi(self, Form21):
        ...
        self.label_matchName2.setText(_translate("Form21", 'Любой текст, после которого ставится <b>запяутая</b>, не меняется программой'))
        self.matchName1.setText(_translate("Form21", "Татами №#, Юноши 14 лет"))
