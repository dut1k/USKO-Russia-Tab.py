...
from Kata20210327 import KataMainWindow
from Kumite20210327 import KumiteMainWindow
...
class Ui_Form0(object):
    def setupUi0(self, Form0):
        ...
        Form0.setStatusTip("")
        Form0.setStyleSheet("background-color: rgb(200, 200, 200);")
        self.pushButton_Kata = QtWidgets.QPushButton(Form0)
        self.pushButton_Kata.setGeometry(QtCore.QRect(240, 130, 75, 25))
        self.pushButton_Kata.setObjectName("pushButton_Kata")
        self.pushButton_Kumite = QtWidgets.QPushButton(Form0)
        self.pushButton_Kumite.setGeometry(QtCore.QRect(500, 140, 75, 40))
...
class dialogWindow_Ui(object):
    def setupUi_dialog(self, Dialog):
        ...
        self.buttonBox.setStyleSheet("background-color: rgb(62, 106, 225); font-family: Gotham;"
        ...
        self.label.setStyleSheet("font-family: Gotham; font-size: 15pt;")
        self.label.setAlignment(QtCore.Qt.AlignCenter)
        self.label.setObjectName("label")

        self.label2 = QtWidgets.QLabel(Dialog)
        self.label2.setGeometry(QtCore.QRect(0, 40, 400, 20))
        self.label2.setStyleSheet("color: grey; font-size: 7;")
