...
class KumiteSWindow_Ui(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.matchName22.setText(_translate("Form", "Категория"))
...
class KumiteMainWindow_Ui(QWidget):
    def __init__(self):
        ...
        self.winnerRed = QtWidgets.QRadioButton("Победил АКА", self.Form2)
        self.winnerWhite = QtWidgets.QRadioButton("Победил СИРО", self.Form2)
        ...
        self.winnerRed.setGeometry(QtCore.QRect(580, 140, 165, 25))
        self.winnerRed.setStyleSheet(self.Radio_style_2)
        self.winnerRed.setObjectName("winnerRed")

        self.winnerWhite.setGeometry(QtCore.QRect(135, 140, 180, 25))
        ...
        self.label_score11.setStyleSheet("background-color: None; color: white; border: none;"
