...
# конструктор для matchName ############################################
                self.matchName_dict = sheet.iloc[0:5].to_dict()
                list(map(self.matchName_dict.__delitem__,
                         filter(self.matchName_dict.__contains__, ('a10', 'a11', 'a12', 'a13'))))
                print('sheet.iloc[3].to_dict()', self.matchName_dict)
                # print()
