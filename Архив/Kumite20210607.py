...
##############################################
        ...
        self.matchName22.setStyleSheet("font-family: Gotham-Medium; font-size: 100px; color: grey;")
...
class KumiteMainWindow_Ui(object):
    def setupUi(self, Form2):
        ...
        self.frame_menu = QtWidgets.QFrame(Form2)
        self.MenuButton = QtWidgets.QPushButton(self.frame_menu)
        self.KataQualButton = QtWidgets.QPushButton(self.frame_menu)
        self.KataFinalButton = QtWidgets.QPushButton(self.frame_menu)
        ...
        self.frame_matchName.setGeometry(QtCore.QRect(0, 0, 750, 70))
        ...
        self.pushButton_showData.setGeometry(QtCore.QRect(10, 5, 220, 25))
        self.pushButton_showData.setStyleSheet(btn_style_16)
        self.pushButton_showData.setObjectName("pushButton_showData")

        self.pushButton_clearData.setGeometry(QtCore.QRect(10, 40, 220, 25))
        self.pushButton_clearData.setStyleSheet(btn_style_16)
        self.pushButton_clearData.setObjectName("pushButton_clearData")

        self.label_matchName1.setGeometry(QtCore.QRect(250, 0, 480, 25))
        self.label_matchName1.setStyleSheet("font-family: Gotham-Light; color: white; font-size: 20px;")
        self.label_matchName1.setAlignment(QtCore.Qt.AlignCenter)
        self.label_matchName1.setObjectName("label_matchName1")

        self.label_matchName2.setGeometry(QtCore.QRect(250, 55, 480, 15))
        ...
        self.matchName11.setGeometry(QtCore.QRect(250, 25, 150, 30))
        self.matchName11.setStyleSheet("background-color: #8089A6; border-bottom: 1px solid black;"
                                       "font-family: Gotham-Light; color: white; font-size: 20px;")
        self.matchName11.setAlignment(QtCore.Qt.AlignCenter)
        self.matchName11.setObjectName("matchName11")

        self.matchName12.setGeometry(QtCore.QRect(410, 25, 320, 30))
        self.matchName12.setStyleSheet("background-color: #8089A6; border-bottom: 1px solid black;"
                                       "font-family: Gotham-Light; color: white; font-size: 20px;")
        self.matchName12.setAlignment(QtCore.Qt.AlignCenter)
        self.matchName12.setObjectName("matchName12")

        # self.btn_matchName_accept.setGeometry(QtCore.QRect(0, 15, 30, 26))
        # self.btn_matchName_accept.setStyleSheet("background-color: None; border: none; color: rgb(6, 214, 160);"
        #                               "font-family: Gotham-Bold; font-size: 33px;")
        # self.btn_matchName_accept.setObjectName("btn_matchName_accept")
        #
        # self.btn_matchName_denied.setGeometry(QtCore.QRect(450, 15, 30, 30))
        # self.btn_matchName_denied.setStyleSheet("background-color: None; border: none; color: rgb(239, 71, 111);"
        #                               "font-family: Gotham-Bold; font-size: 30px;")
        # self.btn_matchName_denied.setObjectName("btn_matchName_denied")
        ...
        self.frame_winner.setGeometry(QtCore.QRect(135, 140, 630, 25))
        ...
        self.frame_red1.setGeometry(QtCore.QRect(475, 140, 400, 240))
        ...
        self.frame_white1.setGeometry(QtCore.QRect(25, 140, 400, 240))
        ...
        self.control_panel.setGeometry(QtCore.QRect(0, 70, 750, 70))
        ...
        self.frame_timeRound2.setStyleSheet("background-color: #e9e9e9; border-radius: 10px;")
        self.frame_timeRound2.setObjectName("frame_white")
        ...
        self.pushButton_reset.setGeometry(QtCore.QRect(570, 40, 170, 20))
        # self.pushButton_reset.setStyleSheet("background-color: #3e6ae1; color: white;"
        #                                     "font-family: Gotham-Light; font-size: 10px;")
        # self.pushButton_reset.setStyleSheet("background-color: #faf9f9; font-family: Gotham-Light; font-size: 10px;")
        self.pushButton_reset.setStyleSheet(btn_style_16)
        self.pushButton_reset.setObjectName("pushButton_reset")

        self.pushButton_pause.setGeometry(QtCore.QRect(570, 10, 170, 25))
        # self.pushButton_pause.setStyleSheet("background-color: #faf9f9; font-family: Gotham-Light; font-size: 17px;")
        self.pushButton_pause.setStyleSheet(btn_style_16)
        self.pushButton_pause.setObjectName("pushButton_pause")

        self.pushButton_start.setGeometry(QtCore.QRect(230, 15, 115, 40))
        # self.pushButton_start.setStyleSheet("background-color: #faf9f9; font-family: Gotham-Light; font-size: 26px;")
        self.pushButton_start.setStyleSheet(btn_style_16)
        ...
        self.frame_rh.setGeometry(QtCore.QRect(475, 400, 405, 40))
        ...
        self.frame_rj.setGeometry(QtCore.QRect(475, 450, 405, 40))
        ...
        self.frame_wh.setGeometry(QtCore.QRect(25, 400, 405, 40))
        ...
        self.frame_wj.setGeometry(QtCore.QRect(25, 450, 405, 40))
        ...
        self.minus2sec.raise_()
        self.plus2sec.raise_()
    ...
    def retranslateUi(self, Form2):
        ...
        # self.btn_matchName_accept.setText(_translate("Form2", "v"))
        # self.btn_matchName_denied.setText(_translate("Form2", "✖"))
        ...
        self.pushButton_clearData.setText(_translate("Form2", "ОЧИСТИТЬ ДАННЫЕ"))
        self.pushButton_showData.setText(_translate("Form2", "ПОКАЗАТЬ НА ЭКРАНЕ"))
...
class KumiteMainWindow(QWidget, KumiteMainWindow_Ui):
    ...
    def update_time(self):
        ...
        if self.tics <= datetime.strptime(str('00:00'), '%M:%S'):
            ...
            self.pushButton_start.setStyleSheet("background-color: yellow; font-family: Gotham-Medium; font-size: 16px;")
            self.lcd1.display(str(self.tics).split()[1])
            self.KumiteSecondWindow.lcd2.display(str(self.tics).split()[1])
    ...
    def setDataKata(self):
        ...
        if firstWindowMatchName1 > 145:
            n = "background-color: none; font-family: Gotham-Medium; font-size: "+ str(int(19.3 * (150 / firstWindowMatchName1))) + "px;"
            self.KumiteSecondWindow.matchName21.setStyleSheet(n)
        else:
            self.KumiteSecondWindow.matchName21.setStyleSheet("background-color: rgb(252, 252, 252); "
                                                              "font-family: Gotham-Light; font-size: 20px;")

        if firstWindowMatchName2 > 235:
            n = "background-color: none; font-family: Gotham-Medium; font-size: "+ str(int(12.5 * (320 / firstWindowMatchName2))) + "px;"
            self.KumiteSecondWindow.matchName22.setStyleSheet(n)
        else:
            self.KumiteSecondWindow.matchName22.setStyleSheet("background-color: rgb(252, 252, 252); "
                                                              "font-family: Gotham-Light; font-size: 20px;")
