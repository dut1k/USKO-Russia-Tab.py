...
class KumiteMainWindow_Ui(object):
    def setupUi(self, Form2):
        ...
        self.frame_matchName.setStyleSheet("background-color: #555B6E; border: none;")
        ...
        self.pushButton_showData.setStyleSheet(btn_style_1)
        ...
        self.pushButton_clearData.setStyleSheet(btn_style_1)
        ...
        self.frame_menu.setStyleSheet("background-color: #BEE3DB;")
        ...
        self.control_panel.setStyleSheet("background-color: #89B0AE;")
        ...
        self.lcd1.setStyleSheet("background-color: None; color:white; border: None")
        ...
        self.pushButton_pause.setStyleSheet("background-color: #3e6ae1; color: white;"
                                            "font-family: Gotham-Light; font-size: 17px;")
        self.pushButton_pause.setObjectName("pushButton_pause")

        self.pushButton_start.setGeometry(QtCore.QRect(230, 15, 115, 40))
        self.pushButton_start.setStyleSheet("background-color: #3e6ae1; color: white;"
                                            "font-family: Gotham-Light; font-size: 26px;")
        ...
        self.frame_rh.setGeometry(QtCore.QRect(475, 400, 380, 40))
        ...
        self.frame_rj.setGeometry(QtCore.QRect(475, 450, 380, 40))
    ...
    def update_time(self):
        ...
        if self.tics <= datetime.strptime(str('00:00'), '%M:%S'):
            ...
            self.pushButton_start.setStyleSheet("background-color: yellow; color: black;"
                                                "font-family: Gotham-Medium; font-size: 16px;")
            self.lcd1.display(str(self.tics).split()[1])
            self.KumiteSecondWindow.lcd2.display(str(self.tics).split()[1])
