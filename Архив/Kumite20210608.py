...
class KumiteMainWindow_Ui(object):
    def setupUi(self, Form2):
        ...
        # self.pushButton_showData.setToolTip('Отобразть на основном экране номер татами и категорию')
        ...
        self.matchName11.setStyleSheet("background-color: #FAF9F9; border-bottom: 1px solid black;"
                                       "font-family: Gotham-Light; color: black; font-size: 20px;")
        ...
        self.matchName12.setStyleSheet("background-color: #FAF9F9; border-bottom: 1px solid black;"
                                       "font-family: Gotham-Light; color: black; font-size: 20px;")
        ...
        # self.frame_timeRound2.setStyleSheet("background-color: #e9e9e9; ")
        ...
        self.slider.setToolTip('Кликай или вращай колёсико мышки')
