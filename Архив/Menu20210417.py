        ...
        if file:
            ...
            #               self.combo.addItems(sorted(df_Single_list[0]))
                ...
                for i in range(1, len(individ_kata.columns.tolist()) + 1):
                    sss.append('КатаЛич')
                individ_kata_dict = dict(zip(individ_kata.columns.tolist(), sss))
                ...
                individ_kumite_dict = dict(zip(individ_kumite.columns.tolist(), sss))
                ...
                for i in range(1, len(team_kata.columns.tolist()) + 1):
                    sss.append('КатаКом')
                team_kata_dict = dict(zip(team_kata.columns.tolist(), sss))
                ...
                team_kumite_dict = dict(zip(team_kumite.columns.tolist(), sss))
