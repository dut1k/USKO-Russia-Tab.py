...
class Ui_Form0(object):
    def setupUi0(self, Form0):
        ...
        self.logo_USKOrus = QPixmap("Images\emblem_usko.png")
        self.logo_VBErus = QPixmap("Images\emblem_vbe_rus.png")
        self.logo_VBEmos = QPixmap("Images\emblem_vbe_msk.png")
        ...
        self.sponsored_by.setGeometry(QtCore.QRect(0, 170, 510, 55)) #justify
        self.sponsored_by.setStyleSheet("font-family: Gotham-Light; text-align: right; color: grey; font-size: 15px;")
        # self.sponsored_by.setAlignment(QtCore.Qt.AlignJustify | QtCore.Qt.AlignVCenter)
        self.sponsored_by.setAlignment(QtCore.Qt.AlignAbsolute)
        # self.sponsored_by.adjustSize()
        self.sponsored_by.setObjectName("sponsored_by")
        # self.logo_USKOrus.setGeometry(QtCore.QRect(340, 50, 250, 250))
        # self.logo_VBEmos.setGeometry(QtCore.QRect(340, 310, 250, 250))
    ...
    def retranslateUi(self, Form0):
        ...
        self.sponsored_by.setText(_translate("self.frame_logo", "При поддержке Президента РФСОО «Федерация восточного\n"
                                                                ...
                                                                "Латкина А.И."))
        self.legend.setText(_translate("Form0", "Программа «Электронное табло USKO RUSSIA». 2021 год"))
...
class MenuWindow(QWidget, Ui_Form0):
    def __init__(self):
        ...
        # Кнопки и списки из окна Кумите, принцып, как в Ката по флажкам
    ...
    def data_processing(self):
        ...
        if self.file:
            try:
                ...
                self.ui_kumite.Form2.setFixedSize(900, 550)
                ...
                self.ui_kumite.Form2.setFixedSize(900, 500)
    ...
    def showKataQualWin(self):
        ...
        self.closeAllWin()
        self.calc_display_moveCoord(self.ui_kataQualSecondWindow.size().width(),
                                    self.ui_kataQualSecondWindow.size().height(), 'SecondWindow')
        self.ui_kataQualSecondWindow.move(self.coord_x1, self.coord_y1)
        self.ui_kataQualSecondWindow.show()
        self.ui_kataQual.show()
        self.calc_display_moveCoord(self.ui_kataQual.size().width(),
                                    self.ui_kataQual.size().height(), 'MainWindow')
        self.ui_kataQual.move(self.coord_x1, self.coord_y1)
        self.ui_kataQual.show()
    ...
    def showKataFinalWin(self):
        self.closeAllWin()
        self.calc_display_moveCoord(self.ui_kataFinalSecondWindow.size().width(),
                                    self.ui_kataFinalSecondWindow.size().height(), 'SecondWindow')
        self.ui_kataFinalSecondWindow.move(self.coord_x1, self.coord_y1)
        self.ui_kataFinalSecondWindow.show()
        self.ui_kataFinal.show()
        self.calc_display_moveCoord(self.ui_kataFinal.size().width(),
                                    self.ui_kataFinal.size().height(), 'MainWindow')
        self.ui_kataFinal.move(self.coord_x1, self.coord_y1)
        self.ui_kataFinal.show()
        self.close()
        if self.sportsmans_ages_dict == {}:
    ...
    def showKumiteWin(self):
        ...
        self.closeAllWin()
        self.calc_display_moveCoord(self.ui_kumiteSecondWindow.size().width(),
                                    self.ui_kumiteSecondWindow.size().height(), 'SecondWindow')
        self.ui_kumiteSecondWindow.move(self.coord_x1, self.coord_y1)
        self.ui_kumiteSecondWindow.show()
        self.ui_kumite.show()
        self.calc_display_moveCoord(self.ui_kumite.size().width(),
                                    self.ui_kumite.size().height(), 'MainWindow')
        self.ui_kumite.move(self.coord_x1, self.coord_y1)
        self.ui_kumite.show()
    ...
    def closeAllWin(self):
        self.ui_kumiteSecondWindow.close()
        self.ui_kumite.close()
        self.ui_kataQualSecondWindow.close()
        self.ui_kataQual.close()
        self.ui_kataFinalSecondWindow.close()
