...
###########################
        ...
        # self.plus2sec.setGeometry(QtCore.QRect(190, 13, 40, 17))
        ...
        # self.minus2sec.setGeometry(QtCore.QRect(190, 33, 40, 17))
...
class KumiteMainWindow(QWidget, KumiteMainWindow_Ui):
    ...
    def upTime(self):
        if self.tics >= datetime.strptime(str('00:00'), '%M:%S') and self.tics < self.datetime:
            ...
            if self.pushButton_start.text() == '▇ Stop':
                ...
                pass
        elif self.tics <= datetime.strptime(str('00:00'), '%M:%S'):
            self.tics += timedelta(seconds=2)
            self.lcd1.display(str(self.tics).split()[1])
            self.KumiteSecondWindow.lcd2.display(str(self.tics).split()[1])
    ...
    def downTime(self):
        ...
        #         self.KumiteSecondWindow.lcd2.display(str(self.tics).split()[1])
        #         if self.tics <= datetime.strptime(str('00:00'), '%M:%S'):
        #             self.tics = datetime.strptime(str('00:01'), '%M:%S')
        #             self.lcd1.display(str(self.tics).split()[1])
        #             self.KumiteSecondWindow.lcd2.display(str(self.tics).split()[1])
        #     elif self.pushButton_start.text() == '► Start':
        #         self.tics -= timedelta(seconds=2)
    ...
    def update_time(self):
        ...
        if self.tics == datetime.strptime(str('00:00'), '%M:%S'):
            ...
            # self.datetime = datetime.strptime(str('00:00'), '%M:%S')
        if self.tics < datetime.strptime(str('00:00'), '%M:%S'):
            # self.tics = datetime.strptime(str('00:00'), '%M:%S')
            self.tics = datetime.strptime(str('00:00'), '%M:%S')
            self.timer.stop()
