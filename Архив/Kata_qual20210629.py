...
class Frame_Header(QWidget):
    def __init__(self, parent):
        ...
        self.label_windowsTitle = QLabel("Ката по флажкам. Судейское окно", self.frame_title)
...
class KataQual_MainWindow_Ui(QWidget):
    def __init__(self):
        ...
        # self.lineEdit_name_red_1 = QtWidgets.QLineEdit("АКА. Введите имя спортсмена", self.Form21)
        self.lineEdit_name_red_1 = QtWidgets.QLineEdit(self.Form21, placeholderText="АКА. Введите имя спортсмена")
        self.lineEdit_region_red_1 = QtWidgets.QLineEdit(self.Form21, placeholderText="АКА. Введите регион")
        self.lineEdit_name_white_1 = QtWidgets.QLineEdit(self.Form21, placeholderText="СИРО. Введите имя спортсмена")
        self.lineEdit_region_white_1 = QtWidgets.QLineEdit(self.Form21, placeholderText="СИРО. Введите регион")
        ...
        self.frame_matchName.setGeometry(QtCore.QRect(200, 00, 500, 70))
        ...
        self.frame_red1.setStyleSheet("background-color: rgb(255, 222, 219); border-radius: 15px;")
        ...
        self.frame_winner.setGeometry(QtCore.QRect(135, 120, 630, 25))
