...
class KataSecondWindow_Ui(object):
    def setupUi_Kata2(self, Form12):
        ...
        Form12.setStyleSheet("background-color: #3c3f41;")
        ...
        self.label_sum2.setStyleSheet("background-color: #333333; border: None; font-family: Gotham-Bold;"
                                      "color: #bbbbbb; font-size: 350px; ")
        ...
        self.label_1.setStyleSheet("font-family: Gotham-Medium; color: #5e6164; font-size: 35px; ")
        ...
        self.label_2.setStyleSheet("font-family: Gotham-Medium; color: #5e6164; font-size: 35px; ")
        self.label_2.setAlignment(QtCore.Qt.AlignBottom | QtCore.Qt.AlignHCenter)
        self.label_2.setObjectName("label_2")

        self.label_3.setGeometry(QtCore.QRect(580, 680, 250, 50))
        self.label_3.setStyleSheet("font-family: Gotham-Medium; color: #5e6164; font-size: 35px; ")
        ...
        self.label_4.setStyleSheet("font-family: Gotham-Medium; color: #5e6164; font-size: 35px; ")
        ...
        self.label_5.setStyleSheet("font-family: Gotham-Medium; color: #5e6164; font-size: 35px; ")
        ...
        self.label_6.setStyleSheet("font-family: Gotham-Medium; color: #5e6164; font-size: 35px; ")
        ...
        self.label_7.setStyleSheet("font-family: Gotham-Medium; color: #5e6164; font-size: 35px; ")
        ...
        self.label_name_red_2.setStyleSheet("background-color: None; font-family: Gotham-Medium;"
                                            "color: white; font-size: 133px;")
        ...
        self.label_region_red_2.setStyleSheet("background-color: None; font-family: Gotham-Medium;"
                                              "color: white; font-size: 53px;")
...
class KataSecondWindow(QWidget, KataSecondWindow_Ui):
    ...
    def extreamLabelStyle(self, input_referee):
        input_referee.setStyleSheet("background-color: #333333; border: None; font-family: Gotham-Medium;"
                                    "color: #5e6164; font-size: 120px; text-align : left")
...
class KataMainWindow_Ui(QWidget):
    ...
    def onChanged(self, text):
        ...
        if text == ".":
            ...
            if sender == self.lineEdit_referee1:
                self.input_refereeStyle(self.KataSecondWindow.input_referee1, text)
            elif sender == self.lineEdit_referee2:
                self.input_refereeStyle(self.KataSecondWindow.input_referee2, text)
            elif sender == self.lineEdit_referee3:
                self.input_refereeStyle(self.KataSecondWindow.input_referee3, text)
            elif sender == self.lineEdit_referee4:
                self.input_refereeStyle(self.KataSecondWindow.input_referee4, text)
            elif sender == self.lineEdit_referee5:
                self.input_refereeStyle(self.KataSecondWindow.input_referee5, text)
            elif sender == self.lineEdit_referee6:
                self.input_refereeStyle(self.KataSecondWindow.input_referee6, text)
            elif sender == self.lineEdit_referee7:
                self.input_refereeStyle(self.KataSecondWindow.input_referee7, text)

    def input_refereeStyle(self, input_referee, text):
        input_referee.setStyleSheet(
            "background-color: #333333; border: None; font-family: Gotham-Medium; color: black; font-size: 150px; text-align: left")
        input_referee.setText(text)
    ...
    def labelStyle(self, input_referee):
        input_referee.setStyleSheet( "background-color: #333333; border: None; font-family: Gotham-Medium;"
                                     "color: black; font-size: 150px; text-align: left")
